...
const Counter = ({deadline}) => {
	...
	return (
		<div className="flex items-center justify-center relative z-20">
			<div className="text-4xl md:text-6xl font-tenez text-primary-200 px-1.5 md:px-4 inline-flex flex-col items-center">
				{leading0(state.days)}
				<span className="uppercase block text-lg">dies</span>
			</div>
			<span className="text-2xl text-primary-200 opacity-80">:</span>
			<div className="text-4xl md:text-6xl font-tenez text-primary-200 px-1.5 md:px-4 inline-flex flex-col items-center min-w-[70px] md:min-w-[100px]">
