	...
	return (
		<>
			...
			<div className="main">
				...
				{/* Section intro  */}
				<section className="flex flex-wrap items-stretch overflow-hidden">
				...
				<section className="relative p-14 flex justify-end">
					...
					<div className="p-14 bg-white relative z-10 w-full lg:w-5/12">
						...
						<div className="absolute bottom-0 right-0 opacity-60 z-0">
							<picture>
								<img
				...
				<section className="relative lg:pt-40 lg:pb-32">
					<div className="container">
						<div className="w-full lg:w-5/12 lg:mx-auto">
							<h2>
								Que a quina hora heu de ser-hi, o què hi farem? Aquesta és
								l'agenda del dia; feu-li un cop d'ull.
							</h2>
							<ul>
								<li>
									<svg
